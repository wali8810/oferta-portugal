...
const whatYouGetItems = [
    {
        icon: "✅",
        description: "Poupar horas de trabalho com artes prontas"
    },
    {
        icon: "✅",
        description: "Ter mais variedade para oferecer às suas clientes"
    },
    {
        icon: "✅",
        description: "Criar produtos mais rápidos e profissionais"
    },
    {
        icon: "✅",
        description: "Aumentar o valor percebido das suas encomendas"
    },
    {
        icon: "✅",
        description: "Trabalhar com mais leveza e menos esforço"
    }
]
        ...
        <>
            <section className="relative w-full pb-10 overflow-hidden text-white pt-12 md:pt-20 bg-gradient-to-br from-pink-500 via-red-500 to-orange-500">
              <div className="relative container mx-auto px-4 text-center z-10">
                ...
                Quero mesmo que tenha sucesso, e acredito que o preço não deve ser um obstáculo. Por isso, preparei uma <span className="bg-green-500 text-white px-1 rounded-sm">condição especial e única</span>: acesso ao PACOTE DE ARTES EXTRAS por apenas €10.
                </p>
