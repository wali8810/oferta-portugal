...
const includedFeatures = [
  "Artes digitais prontas",
  "Acesso imediato",
  "Uso ilimitado",
  "Compatível com o método principal"
];
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-2xl mx-auto bg-white text-black rounded-2xl shadow-2xl border-4 border-yellow-400 p-6 md:p-8 w-full animate-pulse-yellow">
          ...
          <div className="text-center my-4">
            <h3 className="font-bold text-lg">PACOTE DE ARTES EXTRAS</h3>
          </div>
          ...
          <div className="text-center my-6">
            <p className="text-red-500 line-through text-xl">Preço Original: €29,90</p>
          ...
          <div className="mt-auto">
            ...
            <p className="text-sm font-bold text-gray-700 text-center mt-4">⚠️ ATENÇÃO: <span className="font-normal">Esta é uma oferta única. Se sair desta página, <u className="font-bold">perde o acesso</u> a este valor para sempre.</span></p>
          </div>
        </div>
      </div>
    </section>
