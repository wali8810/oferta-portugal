            ...
            <div className="flex flex-col items-center">
                ...
                <div className="text-center mt-8">
                    ...
                    <div className="max-w-2xl mx-auto text-muted-foreground text-lg">
                        <p className="mb-4">Adicione as VÍDEO-AULAS EXCLUSIVAS ao seu pedido. Veja todo o conteúdo, aplique o que aprendeu e teste sem risco. Se dentro de 30 dias não sentir que este foi um excelente investimento de €14,90, devolvo-lhe cada cêntimo.</p>
            ...
            <div className="mb-4">
                <a href="#plans" className="inline-block">
                  <Button size="lg" className="cta-button shadow-lg text-center h-auto whitespace-normal animate-pulse-green leading-tight text-lg md:text-xl py-3 px-6 md:py-4">
                    SIM, EU QUERO O ACESSO ÀS VÍDEO-AULAS EXCLUSIVAS POR APENAS €14,90!
                  </Button>
                </a>
            </div>
        </div>
