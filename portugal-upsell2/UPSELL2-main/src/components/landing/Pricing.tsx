...
const includedFeatures = [
  "Pack completo de Artes Extras organizadas por temas",
  "Conteúdo digital, acesso imediato",
  "Compatível com os moldes do método",
  "Uso ilimitado para os seus projetos",
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-2xl mx-auto bg-white text-black rounded-2xl shadow-2xl border-4 border-yellow-400 p-6 md:p-8 w-full animate-pulse-yellow">
          <div className="text-center mb-6">
            <h2 className="text-2xl md:text-3xl font-extrabold uppercase tracking-wide text-black">O Que Leva Neste Pacote Exclusivo:</h2>
          </div>
          ...
          <div className="text-center my-6">
            <p className="text-red-500 line-through text-xl">Valor Normal: €29,90</p>
          ...
          <div className="mt-auto">
            ...
            <p className="text-sm font-bold text-gray-700 text-center mt-4">⚠️ ATENÇÃO: <span className="font-normal">Esta oferta <u className="font-bold">expira</u> assim que sair desta página.</span></p>
          </div>
        </div>
      </div>
    </section>
