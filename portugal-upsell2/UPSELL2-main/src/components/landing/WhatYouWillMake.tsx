      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold uppercase tracking-tighter leading-tight mb-2 text-black font-montserrat">
            <span role="img" aria-label="pointing finger">👉</span> Mais criatividade, menos esforço.
          </h2>
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
            Tenha sempre uma arte pronta para cada ocasião e surpreenda as suas clientes.
          </p>
        </div>
